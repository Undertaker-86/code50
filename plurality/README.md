---
files: [plurality.c]
url: https://cdn.cs50.net/2022/fall/psets/3/plurality/README.md
window: [terminal]
---
...
```
check50 cs50/problems/2022/fall/plurality
```
...
1. Click "Problem Set 3: Plurality".
1. Drag and drop your `plurality.c` file to the area that says "Drag & Drop". Be sure it has that **exact** filename! If you upload a file with a different name, the autograder likely will fail when trying to run it, and ensuring you have uploaded files with the correct filename is your responsibility!
1. Click "Upload".
