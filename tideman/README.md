---
files: [tideman.c]
url: https://cdn.cs50.net/2022/fall/psets/3/tideman/README.md
window: [terminal]
---
...
{% video https://www.youtube.com/watch?v=kb83NwyYI68 %}
...
```
check50 cs50/problems/2022/fall/tideman
```
...
1. Click "Problem Set 3: Tideman".
1. Drag and drop your `tideman.c` file to the area that says "Drag & Drop". Be sure it has that **exact** filename! If you upload a file with a different name, the autograder likely will fail when trying to run it, and ensuring you have uploaded files with the correct filename is your responsibility!
1. Click "Upload".
