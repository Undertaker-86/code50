...
{% spoiler "Hint" %}
Declared in `ctype.h` is a function that you might find helpful, per <https://manual.cs50.io/>. If you use it, be sure to include that header file atop your own code!
{% endspoiler %}
...
{% spoiler "Hints" %}
* Recall that `round` is declared in `math.h`, per <https://manual.cs50.io/>!
...
{% video https://www.youtube.com/watch?v=AOVyZEh9zgE %}
...
```
check50 cs50/problems/2022/fall/readability
```
